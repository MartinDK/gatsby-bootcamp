...
- Preferably stop on the side of the road instead of using toilet to limit lost time standing in que to use toilet.
...
I drank regularly and but only had two toilet stops, half way up Mt Hotham and in Omeo.
...
My training this year wasn't ideal, I didn't do enough long rides. My ftp 270W(Garmin) and VO2 55 ml/kg/min(Garmin) and. I generally to followed the recommendations from my Garmin 745. I needed to do more endurance rides with climbs.

### Event Training Rides

I did one training rides with Bicycle Network in Lake Mountain .
